...
This file is copied from ``config.py`` so the original OpenPI training configs
stay untouched. PI0/PI05 configs in this file use ``pi0_config_MOE.Pi0Config``.
"""
...
import openpi.models.pi0_config_MOE as pi0_config
